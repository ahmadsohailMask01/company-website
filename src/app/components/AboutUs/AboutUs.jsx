...
export default function AboutPage() {
  return (
    <div className="bg-[#f0f6ff] text-gray-800 font-poppins">
      {/* Hero Section */}
      <section className="relative bg-[#002049] text-white pt-36 pb-48 px-6 overflow-hidden">
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-white via-[#e6f0ff] to-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed text-gray-700 max-w-3xl mx-auto animate__animated animate__fadeInUp animate__delay-1s">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={i} className="bg-[#e3efff] p-8 rounded-3xl shadow-lg text-center transition-all duration-300 animate__animated animate__fadeInUp">
      ...
      <section className="py-20 px-6 bg-[#f9fbff]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 items-center md:grid-cols-4 justify-center gap-12">
