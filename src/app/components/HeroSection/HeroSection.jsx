...
const HeroSection = () => {
  ...
  return (
    <>
      <section
        className={`h-[130vh] md:h-[160vh] flex flex-col space-y-8  text-center font-poppins items-center bg-[url(/images/HeroBackground.svg)]  bg-center justify-center  bg-no-repeat  text-white  w-full lg:h-[710px] `}
      >
