...
export default function Testimonials() {
  ...
  return (
    <section className=" flex flex-col text-center items-center justify-center font-poppins w-full p-8 bg-[#002049] text-white">
            <p className="text-4xl font-extrabold leading-6">REAL STORIES : <span className="text-[#2f7af7]"> REAL IMPACT</span> </p>
            <p className="font-light text-base leading-4 my-4">Discover how our customers are achieving remarkable results with the help of our solutions.</p>
        <div className="inline-block justify-center items-center bg-transparent w-[89%] rounded-2xl mb-2 overflow-hidden">
